...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void initState() {
    super.initState();
    _bindController(_identifierController, (value) => identifier = value);
  ...
  Future<void> handleLogin() async {
    ...
    try {
      final result = await AppLoadingOverlay.of(context).run<LoginResult>(
      ...
      final normalizedRole = result.role.toLowerCase();

      if (normalizedRole == 'user') {
        Navigator.pushNamedAndRemoveUntil(context, '/home', (route) => false);
      } else if (normalizedRole == 'talent') {
        ...
        await _showLoginResultDialog(
          title: 'Login Gagal',
          message:
              'Role "$normalizedRole" dari backend belum didukung di aplikasi.',
        );
      }
  ...
  Future<void> _showLoginResultDialog({
      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [Color(0xFFFFF8E1), Color(0xFFFFF3E0), Color(0xFFFFECB3)],
          ),
        ),
        child: SafeArea(
          child: Center(
                          ...
                          child: Row(
                            children: [
                              Expanded(
                                child: TextButton(
                                  onPressed: () =>
                                      setState(() => loginType = 'user'),
                                  style: TextButton.styleFrom(
                                    backgroundColor: loginType == 'user'
                                        ? Colors.white
                                        : Colors.transparent,
                                    foregroundColor: loginType == 'user'
                                        ? Color(0xFF92400E)
                                        : Color(0xFF6B7280),
                              ...
                              Expanded(
                                child: TextButton(
                                  onPressed: () =>
                                      setState(() => loginType = 'talent'),
                                  style: TextButton.styleFrom(
                                    backgroundColor: loginType == 'talent'
                                        ? Colors.white
                                        : Colors.transparent,
                                    foregroundColor: loginType == 'talent'
                                        ? Color(0xFF92400E)
                                        : Color(0xFF6B7280),
                                    shape: const RoundedRectangleBorder(
                                      borderRadius: BorderRadius.zero,
